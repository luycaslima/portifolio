...
export const About = forwardRef<HTMLElement>((_props,ref) => {
    return (
        <section ref={ref} className="my-24 mx-auto px-3 xl:m-24">
            <SectionTitle name="ABOUT"/>
            <div className="flex justify-center items-center flex-col md:flex-row gap-2">
                <div className="mx-auto relative flex items-center justify-center w-3/4 md:w-full">
                    <img className="absolute animate-reverse-spin " src="/white_square.svg" alt="white square" />
                    <div className="absolute leading-[5rem]  md:leading-[7rem] text-ghostWhite text-7xl md:text-9xl font-keania-one stroke max-h-full">
                        <h1 className="select-none">L2</h1>
                        <h1 className="select-none">2L</h1>
                    </div>
                    <img src="/profile_pic.svg" alt="profile pic" />
                </div>
                <div className="flex flex-col justify-center mx-auto items-center w-4/5 xl:max-w-screen-sm">
                     <div className="font-righteous">
                        <h2 className="text-3xl py-2">
                            A flexible, dedicated Developer based in Wuppertal, Germany.
                        </h2>
                        <span className="text-orangeRedCrayole text-2xl md:text-4xl select-none break-words">
                            {'>>>>>>>>>>>>>>>>>>>>>>>>>>>>'}
                        </span>
                    </div>
